...
-- tag
load data infile 'D:/zybank/ml-25m/tags.csv'
into table tag
...
-- rating
load data infile 'D:/zybank/ml-25m/ratings.csv'
into table rating
fields terminated by ',' optionally enclosed by '"' escaped by '"'
lines terminated by '\r\n'
ignore 1 lines
...
-- movie
load data infile 'D:/zybank/ml-25m/movies.csv'
into table movie
fields terminated by ',' optionally enclosed by '"' escaped by '"'
lines terminated by '\r\n'
...
-- link
load data infile 'D:/zybank/ml-25m/links.csv'
into table link
fields terminated by ',' optionally enclosed by '"' escaped by '"'
lines terminated by '\r\n'
